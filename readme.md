...
# TODO
- [ ] новый парсер для самописной выгрузки JSON из 1С Розница 2.3 - учесть:
      ...
      3. картинки теперь выгружаются без подпапок в одну кучу, более 1 тыс элементов. Пока по идее не проблема.
