...
# TODO
- [ ] fiber - обновить версию rc3 на финальную 3.0.0
- [ ] удалить индекс qnt_price_registry_nom_vid_idx2, созданный в миграции №19. По факту (на 2026-02-22) не используется и зря занимает место. 
