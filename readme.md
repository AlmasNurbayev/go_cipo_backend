...
- [v] новый парсер для самописной выгрузки JSON из 1С Розница 2.3 - учесть:
      ...
      4. в новой сампописной выгрузке есть ШК, нужно записывать в qnt_price_registry для возможного сопоставления с kaspi
      5. товарная группа теперь выгружается из номенклатуры, а не доп. сведений, проверить соответствие гуидов
      6. Вид номенклатуры, дублируются гуиды - но не используются в таблицах
